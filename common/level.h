...
#define DECODE_BACKGROUND_MAX 0x2C

#define DECODE_SHUTTLE 0x2C
#define DECODE_SHUTTLE_LANDED 0x2D

#define DECODE_EXIT_UNLOCKED 0x2E
#define DECODE_EXIT_LOCK 0x2F
