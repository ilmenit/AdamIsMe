...
mkatr aim.atr -b XBW130.DOS aim.xex SELECTOR.com ENDIF.com PROGRESS.DAT INTRO.XEX OUTRO.XEX LEVELS.AIM LEVELS.ATL STARTUP.BAT 0.fnt 1.fnt 2.fnt 3.fnt 4.fnt 5.fnt 6.fnt 7.fnt 8.fnt 0.inv 1.inv 2.inv 3.inv 4.inv 5.inv 6.inv 7.inv 8.inv
copy aim.atr ..
cd ..
start aim.atr
